...
import AlloyMeshView from "./views/alloy-mesh-view";
...
export default {
    ...
    activate () {
        ...
        this.general_subscriptions = new CompositeDisposable(
            ...
            atom.workspace.addOpener(AlloyMeshView.opener),
    ...
    setActiveItem (item) {
        ...
        if (item instanceof AlloyMeshView) {

            item.setModel(this.solution_model);
            this.showStylesOnly();
        ...
        if (!this.in_styles_layout) {
            ...
            Promise
                ...
                .then(() => atom.workspace
                    ...
                    .then((view) => this.connectStylesView(view))
                );
